      ...
      <div className='p-6 space-y-6'>
        ...
        <div className='bg-base-100 rounded-xl shadow-sm p-5 border border-base-300'>
          ...
          <div className='space-y-3 text-base leading-relaxed'>
            ...
            {problem.description.notes.map((note, idx) => (<p key = {idx} className='text-base-content/90'>{note}</p>))}
          </div>
        </div>
         {/* EXAMPLES SECTION */}
        <div className="bg-base-100 rounded-xl shadow-sm p-5 border border-base-300">
            ...
            {problem.examples.map((example, idx) => (
              <div key={idx}>
                <div className="flex items-center gap-2 mb-2">
                  <span className="badge badge-xl font-bold">{idx + 1}</span>
                  <p className="text-xl font-bold text-base-content">Example {idx + 1}</p>
                </div>
